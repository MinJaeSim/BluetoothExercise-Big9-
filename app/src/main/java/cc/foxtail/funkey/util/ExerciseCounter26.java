...
public class ExerciseCounter26 extends ExerciseCounter {
    private boolean arm;
    ...
    public void counting() {
        boolean motionArmStretch = countHelper.isLeftArmUpStretch() && countHelper.isRightArmUpStretch();
