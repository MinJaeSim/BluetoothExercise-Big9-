...
public class ExerciseCounter12 extends ExerciseCounter {
    private boolean arm;
    ...
    public void counting() {
        boolean motionArmStretch = countHelper.isLeftArmDownStretch() && countHelper.isRightArmDownStretch();
